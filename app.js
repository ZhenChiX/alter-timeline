...
// Here is the test for multiply(); uncomment it to run 
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition, use your sum() function, and to do multiplication, ue your multiply() function that you've already created. You're going to have to be resourceful to figure out how to do this.
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    //testing//
    return [sumResult, multiplyResult, message1, message2];
}
...
function sumArray(sumArr) { //eslint-disable-line
    var result = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
...
function multiplyArray(multArr) { //eslint-disable-line
    var result = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
